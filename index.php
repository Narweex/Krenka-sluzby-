                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <a href="#" class="text-xs font-weight-bold text-gray-800 text-uppercase mb-1 dropdown no-arrow">
                                                
                                                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <a href="#" class="text-xs font-weight-bold text-gray-800 text-uppercase mb-1">Funkční</a>
                                            </a>
